...
bool validationTest(bool needToDisplayTimeUsedByMethods) { // comparing with method which is using counting
    ...
    isTestSuccesful *= findForMostFreqElement(array, arrayLength) == 0;
